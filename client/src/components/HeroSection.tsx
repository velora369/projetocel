    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button
            size="lg"
            className="gap-2 text-base sm:text-lg px-8 py-6 backdrop-blur-sm bg-primary border border-primary-border"
          ...
          <Button
            size="lg"
            variant="outline"
            className="gap-2 text-base sm:text-lg px-8 py-6 backdrop-blur-md bg-background/20 border-white/40 text-white hover:bg-background/30"
